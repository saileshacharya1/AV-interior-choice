...
# configure logging
logging.basicConfig(
    filename='../outputs/2-1-mnl-II-initial.log',  
    level=logging.INFO,              
...
# ---------------------------------------------------------------------------------------------------------------------#
## 2-1-mnl-II-initial
# multinomial logit model with covariates of ASC
...
# model name
biogeme.modelName = "2-1-mnl-II-initial"
...
shutil.move("2-1-mnl-II-initial.html", "../outputs/2-1-mnl-II-initial.html")

# remove intermediate outputs
os.remove("2-1-mnl-II-initial.pickle")
os.remove("__2-1-mnl-II-initial.iter")
