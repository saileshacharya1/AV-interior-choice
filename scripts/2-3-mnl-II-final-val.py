...
# configure logging
logging.basicConfig(
    filename='../outputs/2-3-mnl-II-final-val.log',  
    level=logging.INFO,              
...
# ---------------------------------------------------------------------------------------------------------------------#
## 2-3-mnl-II-final-val
# 5-fold cross-validation of 2-2-mnl-II-final
...
for train_index, test_index in kf.split(df, groups=df["id"]):
    ...
    biogeme.modelName = "2-3-mnl-II-final-val"
    ...
    os.remove("2-3-mnl-II-final-val.pickle")
    os.remove("2-3-mnl-II-final-val.html")
    os.remove("__2-3-mnl-II-final-val.iter")
