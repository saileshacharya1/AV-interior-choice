...
# configure logging
logging.basicConfig(
    filename='../output/4-1-mxl-IV-initial.log',  
    level=logging.INFO,              
...
# ---------------------------------------------------------------------------------------------------------------------#
## 4-1-mxl-IV-initial
# mixed logit model with sociodemographics as ASC
...
# socio-demographics considered as ASC
...
asc_avwl_rnd = (
    ...
    + b_race_1_avwl * race_1
    + b_gender_1_avwl * gender_1
    + b_education_2_avwl * education_2
    + b_education_3_avwl * education_3
    + b_school_2_avwl * school_2
    + b_school_3_avwl * school_3
    + b_hh_adult_avwl * hh_adult
    + b_hh_child_avwl * hh_child
    + b_income_grp_2_avwl * income_grp_2
    + b_income_grp_3_avwl * income_grp_3
    + b_income_grp_4_avwl * income_grp_4
    + b_income_grp_5_avwl * income_grp_5
    + b_employment_2_avwl * employment_2
    + b_employment_3_avwl * employment_3
    + b_driving_exp_avwl * driving_exp
    + b_citation_avwl * citation
    + b_crash_exp_avwl * crash_exp
    + b_hh_vehs_avwl * hh_vehs
    + b_mode_commute_3_avwl * mode_commute_3
    + b_mode_shopping_3_avwl * mode_shopping_3
    + b_mode_personal_3_avwl * mode_personal_3
    + b_mode_social_3_avwl * mode_social_3
    + b_rec_trips_avwl * rec_trips
    + b_av_usefulness_avwl * av_usefulness
    + b_av_concern_avwl * av_concern
    + b_tech_savviness_avwl * tech_savviness
    + b_driving_enjoyment_avwl * driving_enjoyment
    + b_polychronicity_avwl * polychronicity
...
biogeme.modelName = "4-1-mxl-IV-initial"

# get the results in a pandas table
print(biogeme.estimate().getEstimatedParameters())

# move outpts to outputs folder
shutil.move("4-1-mxl-IV-initial.html", "../outputs/4-1-mxl-IV-initial.html")

# remove intermediate outputs
os.remove("4-1-mxl-IV-initial.pickle")
os.remove("__4-1-mxl-IV-initial.iter")
